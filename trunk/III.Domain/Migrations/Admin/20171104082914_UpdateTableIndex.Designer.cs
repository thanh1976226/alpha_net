...
namespace III.Domain.Migrations.Admin
{
    ...
    [Migration("20171104082914_UpdateTableIndex")]
        ...
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("ESEIM.Models.AdAppFunction", b =>
            {
                ...
                b.HasIndex("ApplicationCode")
                    .HasName("IX_VIB_APP_FUNCTION_APP_CODE");

                b.HasIndex("FunctionCode")
                    .HasName("IX_VIB_APP_FUNCTION_FUNC_CODE");
            ...
            modelBuilder.Entity("ESEIM.Models.AdLanguageText", b =>
            {
                ...
                b.HasIndex("LanguageId")
                    .HasName("IX_VIB_LANGUAGE_TEXT_LANG_ID");
            ...
            modelBuilder.Entity("ESEIM.Models.AdOrganization", b =>
            {
                ...
                b.HasIndex("OrgParentCode")
                    .HasName("IX_VIB_ORG_PARENT_CODE");
            ...
            modelBuilder.Entity("ESEIM.Models.AdPermission", b =>
            {
                ...
                b.HasIndex("ApplicationCode")
                    .HasName("IX_VIB_PERMISSION_APP_CODE");

                b.HasIndex("FunctionCode")
                    .HasName("IX_VIB_PERMISSION_FUNC_CODE");

                b.HasIndex("GroupUserCode")
                    .HasName("IX_VIB_PERMISSION_GROUP_CODE");

                b.HasIndex("ResourceCode")
                    .HasName("IX_VIB_PERMISSION_RES_CODE");
            ...
            modelBuilder.Entity("ESEIM.Models.AdPrivilege", b =>
            {
                ...
                b.HasIndex("FunctionCode")
                    .HasName("IX_VIB_PRIVILEGE_FUNC_CODE");

                b.HasIndex("ResourceCode")
                    .HasName("IX_VIB_PRIVILEGE_RES_CODE");
            ...
            modelBuilder.Entity("ESEIM.Models.AdUserInGroup", b =>
            {
                ...
                b.HasIndex("ApplicationCode")
                    .HasName("IX_VIB_USER_IN_GROUP_APP_CODE");

                b.HasIndex("GroupUserCode")
                    .HasName("IX_VIB_USER_IN_GROUP_CODE");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityRoleClaim<string>", b =>
            {
                ...
                b.HasIndex("RoleId")
                    .HasName("IX_ASP_NET_ROLE_CLAIMS_ROLE");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
            {
                ...
                b.HasIndex("UserId")
                    .HasName("IX_ASP_NET_USER_CLAIMS_USER");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserLogin<string>", b =>
            {
                ...
                b.HasIndex("UserId")
                    .HasName("IX_ASP_NET_USER_LOGINS_USER");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserRole<string>", b =>
            {
                ...
                b.HasIndex("RoleId")
                    .HasName("IX_ASP_NET_USER_ROLES_ROLE");
