    ...
    $.app.menu = {
                    ...
                    if ($('.main-menu').data('scroll-to-active') === true) {
                        ...
                        setTimeout(function () {
                            if (position != undefined) {
                                $.app.menu.container.stop().animate({ scrollTop: position.top - 150 }, 300);
        ...
        drillDownMenu: function (screenSize) {
            if ($('.drilldown-menu').length) {
                if (screenSize == 'sm' || screenSize == 'xs') {
                    if ($('#navbar-menu').attr('aria-expanded') == 'true') {
        ...
        change: function () {
            ...
            if (currentBreakpoint) {
                ...
                var name = (w < 768) ? 'xs' : ((w < 992) ? 'sm' : ((w < 1200) ? 'md' : 'lg'));
                var obj = {
                    name: name,
                    width: w + 'px'
                }
    ...
    $.app.nav = {
        ...
        bind_events: function () {
            ...
            $('.navigation-main').on('mouseenter.app.menu', 'li', function () {
                ...
                //#config When the menu is open new close(demo_quynh)
                var $listItem = $(this);
            ...
            $('.navigation-main li.has-sub > a').on('click', function (e) {
                //#add class hover when click(demo_Quynh)
