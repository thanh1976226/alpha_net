...
fm.icelink.webrtc.reliableDataStream = (function(_super) {

  __extends(reliableDataStream, _super);
...
fm.icelink.webrtc.reliableDataReceiveArgs = (function(_super) {

  __extends(reliableDataReceiveArgs, _super);
  ...
  function reliableDataReceiveArgs() {
    ...
    this.setDataString = __bind(this.setDataString, this);
    ...
    this.getDataString = __bind(this.getDataString, this);
    ...
    if (arguments.length === 1 && fm.util.isPlainObject(arguments[0])) {
      reliableDataReceiveArgs.__super__.constructor.call(this);
...
fm.icelink.webrtc.reliableDataChannel = (function(_super) {

  __extends(reliableDataChannel, _super);
  ...
  */
  ...
  function reliableDataChannel() {
    ...
    this.setUnordered = __bind(this.setUnordered, this);

    this.setSubprotocol = __bind(this.setSubprotocol, this);

    this.setOnReceive = __bind(this.setOnReceive, this);

    this.setLabel = __bind(this.setLabel, this);

    this.setIdentifier = __bind(this.setIdentifier, this);
    ...
    this.raiseOnReceiveString = __bind(this.raiseOnReceiveString, this);

    this.raiseOnReceiveBytes = __bind(this.raiseOnReceiveBytes, this);

    this.getUnordered = __bind(this.getUnordered, this);

    this.getSubprotocol = __bind(this.getSubprotocol, this);
    ...
    var label, subprotocol, unordered;
    if (arguments.length === 1 && fm.util.isPlainObject(arguments[0])) {
      reliableDataChannel.__super__.constructor.call(this);
  ...
  */
  ...
  reliableDataChannel.prototype.raiseOnReceiveBytes = function() {
    var dataBytes, link, onReceive, p, _var0;
    link = arguments[0];
  ...
  reliableDataChannel.prototype.raiseOnReceiveString = function() {
    var dataString, link, onReceive, p, _var0;
    link = arguments[0];
...
fm.icelink.webrtc.baseMediaArgs = (function(_super) {
  ...
  */
  ...
  function baseMediaArgs() {
    ...
    this.setDefaultVideoSource = __bind(this.setDefaultVideoSource, this);
    ...
    this.getDefaultVideoSource = __bind(this.getDefaultVideoSource, this);
...
fm.icelink.webrtc.conferenceExtensions = (function() {
  ...
  */
  ...
  conferenceExtensions.sendReliableBytes = function() {
    var channel, conference, dataBytes, flag, link, links, peerId, _i, _len, _var0;
    if (arguments.length === 3) {
      conference = arguments[0];
      channel = arguments[1];
    ...
    if (arguments.length === 4) {
      ...
      link = conference.getLink(peerId);
      _var0 = link;
      return (_var0 !== null && typeof _var0 !== 'undefined') && fm.icelink.webrtc.linkExtensions.sendReliableBytes(link, channel, dataBytes);
    }
  };
  ...
  */
  ...
  conferenceExtensions.sendReliableString = function() {
    var channel, conference, dataString, flag, link, links, peerId, _i, _len, _var0;
    if (arguments.length === 3) {
      conference = arguments[0];
      channel = arguments[1];
    ...
    if (arguments.length === 4) {
      ...
      link = conference.getLink(peerId);
      _var0 = link;
      return (_var0 !== null && typeof _var0 !== 'undefined') && fm.icelink.webrtc.linkExtensions.sendReliableString(link, channel, dataString);
    }
  };
...
fm.icelink.webrtc.linkExtensions = (function() {
  ...
  */
  ...
  linkExtensions.getRemoteVideoControl = function() {
    var index, link, localVideoRenderProvider, _var0;
    if (arguments.length === 2) {
      link = arguments[0];
      index = arguments[1];
  ...
  */
  ...
  linkExtensions.setRemoteAudioVolume = function() {
    var link, remoteStream, volume, _var0;
    link = arguments[0];
    volume = arguments[1];
    remoteStream = fm.icelink.webrtc.linkExtensions.getRemoteStream(link);
    _var0 = remoteStream;
...
fm.icelink.webrtc.serializer = (function(_super) {
  ...
  serializer.deserializeAudioRenderInitializeArgsCallback = function() {
    var audioRenderInitializeArgs, name, nullable, nullable2, str, valueJson, _var0;
  ...
  serializer.deserializeReliableDataChannelArray = function() {
    var list, reliableDataChannelsJson, _var0;
  ...
  serializer.deserializeReliableDataChannelCallback = function() {
    var name, nullable, reliableDataChannel, str, valueJson, _var0;
  ...
  serializer.deserializeReliableDataReceiveArgsCallback = function() {
    var name, reliableDataReceiveArgs, str, valueJson, _var0;
  ...
  serializer.deserializeVideoRenderInitializeArgsCallback = function() {
    var name, nullable, str, valueJson, videoRenderInitializeArgs, _var0;
    videoRenderInitializeArgs = arguments[0];
    name = arguments[1];
    valueJson = arguments[2];
    str = name;
    _var0 = str;
    if ((_var0 !== null && typeof _var0 !== 'undefined') && (str === "clockRate")) {
      nullable = fm.serializer.deserializeInteger(valueJson);
      if (nullable !== null) {
  ...
  serializer.serializeReliableDataChannelCallback = function() {
    var jsonObject, reliableDataChannel, _var0, _var1, _var2;
    reliableDataChannel = arguments[0];
    jsonObject = arguments[1];
    _var0 = reliableDataChannel.getLabel();
    if (_var0 !== null && typeof _var0 !== 'undefined') {
      jsonObject["label"] = fm.serializer.serializeString(reliableDataChannel.getLabel());
    }
    _var1 = reliableDataChannel.getSubprotocol();
    if (_var1 !== null && typeof _var1 !== 'undefined') {
      jsonObject["subprotocol"] = fm.serializer.serializeString(reliableDataChannel.getSubprotocol());
    }
    _var2 = reliableDataChannel.getIdentifier();
    if (_var2 !== null && typeof _var2 !== 'undefined') {
...
fm.icelink.webrtc.jsAudioRenderProvider = (function(_super) {
  ...
  jsAudioRenderProvider.prototype.attachToAudio = function(stream, local) {
    ...
    if (navigator.mozGetUserMedia) {
      ...
      return attachMediaStream(this._audio, stream);
    } else {
      return this._audio.src = URL.createObjectURL(stream);
    }
  };
...
fm.icelink.webrtc.jsVideoRenderProvider = (function(_super) {
  ...
  function jsVideoRenderProvider(scale, isLocal, isScreen) {
    this.applyScale = __bind(this.applyScale, this);
  ...
  jsVideoRenderProvider.prototype.attachToVideo = function(local) {
    ...
    if (navigator.mozGetUserMedia) {
      ...
      if (typeof this._video.srcObject !== 'undefined') {
        ...
        this._video.src = webkitURL.createObjectURL(stream);
      }
    } else if (typeof attachMediaStream !== 'undefined') {
...
fm.icelink.webrtc.mediaStream = (function(_super) {
  ...
  function mediaStream() {
    ...
    this.setAudioVolume = __bind(this.setAudioVolume, this);

    this.getAudioVolume = __bind(this.getAudioVolume, this);
    ...
    this.setVideoRenderProvider = __bind(this.setVideoRenderProvider, this);

    this.getVideoRenderProvider = __bind(this.getVideoRenderProvider, this);

    this.setAudioRenderProvider = __bind(this.setAudioRenderProvider, this);

    this.getAudioRenderProvider = __bind(this.getAudioRenderProvider, this);
  ...
  */
  ...
  mediaStream.prototype.setAudioVolume = function(volume) {
    if (this._audioRenderProvider) {
      return this._audioRenderProvider.setVolume(volume);
    }
  };
...
fm.icelink.webrtc.localMediaStream = (function(_super) {
  ...
  function localMediaStream() {
    ...
    this.getDeviceId = __bind(this.getDeviceId, this);
    ...
    this.toggleVideoPause = __bind(this.toggleVideoPause, this);

    this.toggleAudioPause = __bind(this.toggleAudioPause, this);
  ...
  */
  ...
  fm.icelink.webrtc.setChromeExtension = function(args) {
    var child, head, link, linkExists, _i, _len, _ref;
    if (args.extensionId) {
  ...
  */
  ...
  localMediaStream.prototype.start = function(startArgs) {
    ...
    if (startArgs.getDefaultVideoSource() === fm.icelink.webrtc.videoSource.Screen && navigator.webkitGetUserMedia) {
      if (startArgs.getAudio()) {
        return this.raiseStartFailure(startArgs, new Error('Chrome does not allow audio with screen-sharing.'));
      } else {
        return window.setTimeout(function() {
              ...
              if (event.origin === window.location.origin) {
                ...
                if (message.namespace && message.namespace === 'fm.icelink.webrtc') {
                  if (message.type === 'chooseDesktopMediaSuccess') {
                    ...
                    return _this.raiseStartFailure(startArgs, new Error('Screen-sharing permission denied.'));
                  }
                }
              }
            };
  ...
  localMediaStream.prototype.doStart = function(startArgs, audioDeviceId, videoDeviceId, deprecated) {
    var audio, audioParams, getUserMediaFailure, getUserMediaSuccess, k, o, v, video, videoParams, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3,
      _this = this;
    if (arguments.length === 1) {
      try {
        if (startArgs.getAudio()) {
          return this.getDeviceId(startArgs.getAudioDeviceNumber() || 0, 'audio', function(deviceId) {
      ...
      try {
        if (startArgs.getVideo() && startArgs.getDefaultVideoSource() === fm.icelink.webrtc.videoSource.Camera) {
          return this.getDeviceId(startArgs.getVideoDeviceNumber() || 0, 'video', function(deviceId) {
      ...
      getUserMediaFailure = function(error) {
        ...
        if (!error.message) {
          if (_this._chromeScreenStreamId && startArgs.getDefaultVideoSource() === fm.icelink.webrtc.videoSource.Screen) {
            error = new Error('Screen-sharing permission denied. (The page might need to be loaded using HTTPS.)');
          } else {
...
}).call(this, fm.icelink.webrtc.mediaStream);
  ...
  */
  ...
  fm.icelink.webrtc.getCoreActiveX = function(args) {
    var x64_cc_classId, x86_cc_classId,
      _this = this;
    x86_cc_classId = '703F2279-35DA-1E24-4F1C-6A65FD0DF609';
    x64_cc_classId = '99B11BA9-2DA1-B055-2F6B-F2FC20215C3A';
  ...
  return fm.icelink.webrtc.getVideoContainerActiveX = function(args) {
    ...
    x86_vcc_classId = 'FF48AD66-6392-0DD5-6A1B-FB66F1356CE4';
    x64_vcc_classId = '541A72A8-EDF6-2D21-660E-7EE80D1F89A2';
    return fm.icelink.webrtc.getActiveX(fm.util.extend({
...
(function() {
  var dataChannelStreamClass, dataChannelStreamConstructor, dataChannelStreamPrototype, linkProps, linkPrototype, localMediaStreamProps, localMediaStreamPrototype, prop, reliableDataStreamClass, reliableDataStreamConstructor, reliableDataStreamPrototype, streamType, streamTypes, value, _fn, _i, _len, _results,
    _this = this;
  ...
  */
        ...
        fm.icelink.link.prototype[prop] = (function(prop) {
          return function(channelInfo, dataBytes) {
            ...
            if (fm.icelink.webrtc.willUsePlugin()) {
              ...
              return self.jca['l_' + prop](self.pid, channelInfo.toJson(), dataSBytes);
            } else {
  ...
  fm.icelink.webrtc.dataChannelStream = function(dataChannelInfos, offerDtls) {
    ...
    if (fm.icelink.webrtc.willUsePlugin()) {
      fm.icelink.webrtc.getCoreControl({
        callback: function(cc) {
          var dataChannelInfo, _fn1, _j, _len1;
          self.jca = cc;
    ...
    if (fm.icelink.webrtc.willUsePlugin()) {
      fm.icelink.webrtc.getCoreControl({
        callback: function(cc) {
          ...
          for (_j = 0, _len1 = reliableDataChannels.length; _j < _len1; _j++) {
            dataChannelInfo = reliableDataChannels[_j];
            _fn1(dataChannelInfo);
          }
  ...
  for (prop in reliableDataStreamClass) {
    ...
    _results.push(fm.icelink.webrtc.reliableDataStream[prop] = value);
  }
  return _results;
})();
