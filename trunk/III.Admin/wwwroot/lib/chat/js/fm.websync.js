  ...
  */
  ...
  baseReceiveArgs.prototype.getDataBytes = function() {
    ...
    if (_var1 !== null && typeof _var1 !== 'undefined') {
      ...
      _var3 = fm.crypto.tryBase64Decode(fm.serializer.deserializeString(valueJson), _var2);
...
fm.websync.stateRestoredArgs = (function(_super) {

  __extends(stateRestoredArgs, _super);

  function stateRestoredArgs() {
    if (arguments.length === 1 && fm.util.isPlainObject(arguments[0])) {
      stateRestoredArgs.__super__.constructor.call(this);
      fm.util.attachProperties(this, arguments[0]);
      return;
    }
    stateRestoredArgs.__super__.constructor.call(this);
...
fm.websync.connectArgs = (function(_super) {
  ...
  */
  ...
  function connectArgs() {
    ...
    this.setOnStateRestored = __bind(this.setOnStateRestored, this);
    ...
    this.getOnStateRestored = __bind(this.getOnStateRestored, this);
...
fm.websync.messageTransfer = (function(_super) {
  ...
  function messageTransfer() {
    ...
    this.messageRequestArgsToHttpRequestArgs = __bind(this.messageRequestArgsToHttpRequestArgs, this);

    this.httpResponseArgsToMessageResponseArgs = __bind(this.httpResponseArgsToMessageResponseArgs, this);
    if (arguments.length === 1 && fm.util.isPlainObject(arguments[0])) {
...
fm.websync.httpMessageTransfer = (function(_super) {

  __extends(httpMessageTransfer, _super);
  ...
  */
  ...
  function httpMessageTransfer() {
    ...
    this.sendMessages = __bind(this.sendMessages, this);
    if (arguments.length === 1 && fm.util.isPlainObject(arguments[0])) {
      httpMessageTransfer.__super__.constructor.call(this);
...
fm.websync.baseClient = (function(_super) {
  ...
  */
  ...
  function baseClient() {
    ...
    this.setDomainKeyString = __bind(this.setDomainKeyString, this);
    ...
    this.getDomainKeyString = __bind(this.getDomainKeyString, this);
...
fm.websync.client = (function(_super) {
  ...
  */
  ...
  function client() {
    ...
    this.removeOnStateRestored = __bind(this.removeOnStateRestored, this);
    ...
    this.receiveSink = __bind(this.receiveSink, this);
    ...
    this.raiseStateRestored = __bind(this.raiseStateRestored, this);
    ...
    this.maybeRaiseStateRestored = __bind(this.maybeRaiseStateRestored, this);
    ...
    this.decrementPendingRestoreStateCalls = __bind(this.decrementPendingRestoreStateCalls, this);
    ...
    this.addOnStateRestored = __bind(this.addOnStateRestored, this);
  ...
  */
  ...
  client.prototype.addSubscribedChannels = function() {
    var channels, dictionary, str, tag, _i, _len, _results, _var0, _var1, _var2;
    tag = arguments[0];
    ...
    for (_i = 0, _len = _var2.length; _i < _len; _i++) {
      ...
      if (!fm.hashExtensions.containsKey(dictionary, str)) {
        _results.push(dictionary[str] = new fm.object());
      } else {
  ...
  */
  ...
  client.prototype.getSubscribedChannels = function() {
    var dictionary, list, str, str2, tag, _i, _j, _k, _len, _len1, _len2, _var0, _var1, _var2, _var3;
    if (arguments.length === 1) {
      tag = arguments[0];
      list = [];
      dictionary = null;
      ...
      _var2 = dictionary;
      if (_var2 !== null && typeof _var2 !== 'undefined') {
        _var3 = fm.hashExtensions.getKeys(dictionary);
    ...
    if (arguments.length === 0) {
      ...
      for (_j = 0, _len1 = _var0.length; _j < _len1; _j++) {
        str = _var0[_j];
        _var1 = fm.hashExtensions.getKeys(this._subscribedChannels[str]);
        for (_k = 0, _len2 = _var1.length; _k < _len2; _k++) {
          str2 = _var1[_k];
  ...
  */
  ...
  client.prototype.maybeRaiseStateRestored = function() {
    var connectArgs, _var0;
    if (this.decrementPendingRestoreStateCalls() === 0) {
  ...
  */
  ...
  client.prototype.raiseStateRestored = function() {
    var args, args2, connectArgs, onStateRestored, _var0, _var1;
    connectArgs = arguments[0];
  ...
  client.prototype.raiseStreamFailure = function() {
    var args, args2, connectArgs, connectArgsOut, onStreamFailure, responseArgs, retry, _var0, _var1;
    connectArgs = arguments[0];
    responseArgs = arguments[1];
    retry = arguments[2];
  ...
  client.prototype.reconnect = function() {
    var connectArgs, connectArgsOut, flag, responseArgs, _var0, _var1, _var2;
    connectArgs = arguments[0];
    responseArgs = arguments[1];
    connectArgsOut = null;
  ...
  */
  ...
  client.prototype.streamCallback = function() {
    var dynamicValue, lastInterval, message, responseArgs, threadId, _i, _len, _var0, _var1, _var2;
    responseArgs = arguments[0];
    dynamicValue = responseArgs.getDynamicValue(fm.websync.client._argsKey);
...
fm.websync.webSocketMessageTransfer = (function(_super) {

  __extends(webSocketMessageTransfer, _super);
  ...
  */
  ...
  function webSocketMessageTransfer() {
    ...
    var url;
    if (arguments.length === 1 && fm.util.isPlainObject(arguments[0])) {
      webSocketMessageTransfer.__super__.constructor.call(this);
