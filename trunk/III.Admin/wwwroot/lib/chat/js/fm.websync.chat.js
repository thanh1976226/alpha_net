...
fm.websync.chat.userClientJoinArgs = (function(_super) {

  __extends(userClientJoinArgs, _super);
  ...
  */
  ...
  function userClientJoinArgs() {
    ...
    if (arguments.length === 1 && fm.util.isPlainObject(arguments[0])) {
      userClientJoinArgs.__super__.constructor.call(this);
      fm.util.attachProperties(this, arguments[0]);
      return;
    }
    channel = arguments[0];
    subscribedClient = arguments[1];
    userClientJoinArgs.__super__.constructor.call(this, channel, subscribedClient);
  }
...
fm.websync.chat.userClientLeaveArgs = (function(_super) {

  __extends(userClientLeaveArgs, _super);
  ...
  */
  ...
  function userClientLeaveArgs() {
    ...
    if (arguments.length === 1 && fm.util.isPlainObject(arguments[0])) {
      userClientLeaveArgs.__super__.constructor.call(this);
      fm.util.attachProperties(this, arguments[0]);
      return;
    }
    channel = arguments[0];
    unsubscribedClient = arguments[1];
    userClientLeaveArgs.__super__.constructor.call(this, channel, unsubscribedClient);
  }
...
fm.websync.chat.chatClient = (function(_super) {
...
fm.websync.chat.chatUser = (function(_super) {
  ...
  */
  ...
  function chatUser() {
    ...
    this.setClients = __bind(this.setClients, this);

    this.setClientId = __bind(this.setClientId, this);

    this.setBoundRecords = __bind(this.setBoundRecords, this);

    this.loadClientSet = __bind(this.loadClientSet, this);
    ...
    var boundRecords, clientId, userId, userNickname;
    if (arguments.length === 1 && fm.util.isPlainObject(arguments[0])) {
  ...
  */
  ...
  chatUser.prototype.loadClientSet = function() {
    var clientSet, list, str, _i, _len, _var0;
...
fm.websync.chat.clientExtensions = (function() {
  ...
  */
  ...
  clientExtensions.onReceive = function() {
    var args, args4, dictionary, dictionary2, dynamicValue, obj2, p, user, _var0, _var1, _var2, _var3, _var4, _var5;
    args = arguments[0];
    dynamicValue = args.getDynamicValue(fm.websync.chat.clientExtensions._argsKey);
    ...
    _var0 = user.getUserId();
    if ((args.getPublishingClient().getClientId() !== null) && (_var0 !== null && typeof _var0 !== 'undefined')) {
      ...
      if ((_var1 !== null && typeof _var1 !== 'undefined') && (_var2 !== null && typeof _var2 !== 'undefined')) {
        ...
        _var4 = fm.hashExtensions.tryGetValue(dictionary, user.getUserId(), _var3);
  ...
  clientExtensions.onSubscribeSuccess = function() {
    var args, client, clientArray, dictionary, dynamicValue, state, user, users, _i, _j, _len, _len1, _var0, _var1, _var2;
    args = arguments[0];
    dynamicValue = args.getDynamicValue(fm.websync.chat.clientExtensions._argsKey);
    state = dynamicValue.getDynamicValue(fm.websync.chat.clientExtensions._joinStateKey);
    dynamicValue.unsetDynamicValue(fm.websync.chat.clientExtensions._joinStateKey);
    ...
    if (!state.getBindSuccess()) {
      ...
      users = [];
      _var2 = fm.hashExtensions.getValues(dictionary);
  ...
  clientExtensions.process = function() {
    var args2, args3, args4, args5, args6, args7, args8, channel, dictionary2, dynamicValue, fireEvents, flag, flag2, joinArgs, obj2, onUserClientJoin, onUserClientLeave, onUserJoin, onUserLeave, outputArgs, p, subscriber, type, user, _var0, _var1, _var10, _var2, _var3, _var4, _var5, _var6, _var7, _var8, _var9;
    type = arguments[0];
    ...
    flag2 = false;
    dictionary2 = null;
    _var7 = new fm.holder(dictionary2);
    _var8 = fm.hashExtensions.tryGetValue(dynamicValue, user.getUserId(), _var7);
    dictionary2 = _var7.getValue();
    if (!_var8) {
    ...
    if (flag2) {
      ...
      _var10 = onUserLeave;
      if (fireEvents && (_var10 !== null && typeof _var10 !== 'undefined')) {
  ...
  clientExtensions.raiseJoinFailure = function() {
    var args, args3, args4, args5, channels, exception, exception2, isRejoin, joinArgs, onComplete, onFailure, p, retry, _var0, _var1;
  ...
  clientExtensions.raiseLeaveFailure = function() {
    var args, args3, args4, args5, channels, exception, exception2, leaveArgs, onComplete, onFailure, p, retry, _var0, _var1;
...
fm.websync.chat.joinArgs = (function(_super) {
  ...
  */
  ...
  function joinArgs() {
    ...
    this.setOnUserClientLeave = __bind(this.setOnUserClientLeave, this);

    this.setOnUserClientJoin = __bind(this.setOnUserClientJoin, this);
    ...
    this.getOnUserClientLeave = __bind(this.getOnUserClientLeave, this);

    this.getOnUserClientJoin = __bind(this.getOnUserClientJoin, this);
