var ctxfolder = "/views/admin/assetTransferHeader";
...
app.factory('dataservice', function ($http) {
    ...
    return {
        ...
        insert: function (data, callback) {
            $http.post('/Admin/AssetTransferHeader/Insert', data).success(callback);
        },
        ...
        getGenReqCode: function (callback) {
            $http.post('/Admin/AssetTransferHeader/GenReqCode').success(callback);
        },
