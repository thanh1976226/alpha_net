var ctxfolder = "/views/admin/iotWarning";
...
app.factory('dataservice', function ($http) {
    ...
    return {
        getUser: function (callback) {
            $http.post('/Admin/IotWarning/GetUser').success(callback);
        },
        getCurrency: function (callback) {
            $http.post('/Admin/IotWarning/GetCurrency/').success(callback);
        },
        getItem: function (data, callback) {
            $http.post('/Admin/IotWarning/GetItem/', data).success(callback);
        },
        insert: function (data, callback) {
            $http.post('/Admin/IotWarning/Insert/', data).success(callback);
        },
        detail: function (data, callback) {
            $http.post('/Admin/IotWarning/Detail/', data).success(callback);
        },
        delete: function (data, callback) {
            $http.post('/Admin/IotWarning/Delete/' + data).success(callback);
        },
    }
});
...
app.controller('index', function ($scope, $rootScope, $confirm, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $filter, $translate) {
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('Device').withTitle('Thiết bị').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('Unit').withTitle('Đơn vị').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('FromDate').withTitle('Từ ngày').renderWith(function (data, type) {
        var date = $filter('date')(new Date(data), 'MM/dd/yyyy');
        return data != "" ? $filter('date')(new Date(data), 'dd/MM/yyyy') : null;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('ToDate').withTitle('Đến ngày').renderWith(function (data, type) {
        var date = $filter('date')(new Date(data), 'MM/dd/yyyy');
        return data != "" ? $filter('date')(new Date(data), 'dd/MM/yyyy') : null;
    }));
