...
app.factory('dataservice', function ($http) {
    ...
    return {
        getUser: function (callback) {
            $http.post('/Admin/CMSManagementUtilities/GetUser').success(callback);
        },
        getActivityType: function (callback) {
            $http.post('/Admin/CMSManagementUtilities/GetActivityType').success(callback);
        },
        getAsset: function (callback) {
            $http.post('/Admin/CMSManagementUtilities/GetAsset/').success(callback);
        },
        getItem: function (data, callback) {
            $http.post('/Admin/CMSManagementUtilities/GetItem/', data).success(callback);
        },
        insert: function (data, callback) {
            $http.post('/Admin/CMSManagementUtilities/Insert/', data).success(callback);
        },
        update: function (data, callback) {
            $http.post('/Admin/CMSManagementUtilities/Update/', data).success(callback);
        },
        delete: function (data, callback) {
            $http.post('/Admin/CMSManagementUtilities/Delete/' + data).success(callback);
        },
...
app.controller('index', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $translate) {
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('ActTitle').withTitle('{{ "Utilities" | translate }}').renderWith(function (data, type) {
        return "cảnh sát biển";
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('ActNote').withTitle('{{ "Published" | translate }}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('ActMember').withTitle('{{ "Order" | translate }}').renderWith(function (data, type) {
        if (data != null) {
            var listUser = "";
            var list = data.split(',');
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('ActNote').withTitle('{{ "Created" | translate }}').renderWith(function (data, type) {
        return "1/1/2000";
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('ActNote').withTitle('{{ "Modified" | translate }}').renderWith(function (data, type) {
        return "1/1/2001";
    }));
