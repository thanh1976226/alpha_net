var ctxfolder = "/views/admin/cmsCommnet";
...
app.factory('dataservice', function ($http) {
    ...
    return {
        getUser: function (callback) {
            $http.post('/Admin/CMSComMent/GetUser').success(callback);
        },
        getActivityType: function (callback) {
            $http.post('/Admin/CMSComMent/GetActivityType').success(callback);
        },
        getAsset: function (callback) {
            $http.post('/Admin/CMSComMent/GetAsset/').success(callback);
        },
        getItem: function (data, callback) {
            $http.post('/Admin/CMSComMent/GetItem/', data).success(callback);
        },
        insert: function (data, callback) {
            $http.post('/Admin/CMSComMent/Insert/', data).success(callback);
        },
        update: function (data, callback) {
            $http.post('/Admin/CMSComMent/Update/', data).success(callback);
        },
        delete: function (data, callback) {
            $http.post('/Admin/CMSComMent/Delete/' + data).success(callback);
        },
...
app.controller('index', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $translate) {
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('ActCode').withTitle('Mã hoạt động').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('ActTitle').withTitle('Tiêu đề').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('ActType').withTitle('Kiểu hoạt động').renderWith(function (data, type) {
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('ActNote').withTitle('Mô tả').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('ActMember').withTitle('Thành viên').renderWith(function (data, type) {
        if (data != null) {
            var listUser = "";
            var list = data.split(',');
