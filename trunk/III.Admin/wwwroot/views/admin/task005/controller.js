var ctxfolder = "/views/admin/task005";
...
app.factory('dataservice', function ($http) {
    ...
    return {
        insert: function (data, callback) {
            $http.post('/Admin/task005/insert', data).success(callback);
        },
        update: function (data, callback) {
            $http.post('/Admin/task005/update', data).success(callback);
        },
        //deleteItems: function (data, callback) {
        //    $http.post('/LgVendor/deleteItems', data).success(callback);
        //},
        delete: function (data, callback) {
            $http.post('/Admin/task005/delete/' + data).success(callback);
        },
        getItem: function (data, callback) {
            $http.get('/Admin/task005/getitem/' + data).success(callback);
        },
       
        gettreedataRelationship: function (callback) {
            $http.post('/Admin/task005/gettreedataRelationship/').success(callback);
        },
        gettreedataPosition: function(callback) {
            $http.post('/Admin/task005/gettreedataPosition/').success(callback);
        },
        
        gettreedataCareer: function(callback) {
            $http.post('/Admin/task005/gettreedataCareer/').success(callback);
        },
    }
});
...
app.controller('Ctrl_ESEIM', function ($scope, $rootScope, $compile, $uibModal, dataservice) {
    ...
    $rootScope.validationOptions = {
        ...
        messages: {
            name: {
                required: "Nhập tên liên hệ",
                maxlength: "Tên liên hệ k vượt quá 50 kí tự"
            },
            telephone: {
                required: "Nhập số điện thoại",
                maxlength: "Số điện thoại k vượt quá 50 kí tự"
            },
...
app.controller('index', function ($scope, $rootScope, $compile, $confirm, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $filter) {
    ...
    $scope.initData = function () {
        debugger
        dataservice.gettreedataRelationship(function (result) {
            $scope.treedataRelationship = result.Object;
        });
        //dataservice.gettreedataDistrict(function (result) {
        //    $scope.treedataDistrict = result.Object;
        //});
        dataservice.gettreedataPosition(function (result) {
            $scope.treedataPosition = result.Object;
        });
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('company').withTitle('Công ty').renderWith(function (data, type) {
        return data;
    }));
    ...
    $scope.contextMenu = [
        [function ($itemScope) {
            return '<i class="fa fa-edit"></i>Cập nhật người liên hệ ';
        ...
        [function ($itemScope) {
            return '<i class="fa fa-remove"></i> Xóa người liên hệ này';
        }, function ($itemScope, $event, model) {
    ...
    vm.dtColumns1.push(DTColumnBuilder.newColumn('date_change').withTitle('Ngày thay đổi').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns1.push(DTColumnBuilder.newColumn('column_change').withTitle('Nội dung thay đổi').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns1.push(DTColumnBuilder.newColumn('old_value').withTitle('Giá trị cũ').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns1.push(DTColumnBuilder.newColumn('new_value').withTitle('Giá trị mới').renderWith(function (data, type) {
        return data;
    }));
