...
app.factory('dataservice', function ($http) {
    ...
    return {
        ...
        getCatFund: function (callback) {
            $http.post('/Admin/FundCatReptExps/GetCatFund/').success(callback);
        },
...
app.controller('index', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $translate) {
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('name').withOption('sClass', 'nowrap dataTable-30per').withTitle('{{"Tên" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('group').withOption('sClass', 'nowrap dataTable-30per').withTitle('{{"Nhóm" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('type').withOption('sClass', 'nowrap dataTable-20per').withTitle('{{"Loại" | translate}}').renderWith(function (data, type) {
        return data;
    }));
