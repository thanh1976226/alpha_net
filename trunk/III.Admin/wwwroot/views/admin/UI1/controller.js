...
app.config(function ($routeProvider, $validatorProvider) {
    $routeProvider
        ...
        .when('/addCH/', {
            templateUrl: ctxfolder + '/addCH.html',
            controller: 'addCH'
        })
        .when('/addACE/', {
            templateUrl: ctxfolder + '/addACE.html',
            controller: 'addACE'
        })
        .when('/addHT/', {
            templateUrl: ctxfolder + '/addHT.html',
            controller: 'addHT'
        })
        .when('/addMDH/', {
            templateUrl: ctxfolder + '/addMDH.html',
            controller: 'addMDH'
        })
        .when('/addNC/', {
            templateUrl: ctxfolder + '/addNC.html',
            controller: 'addNC'
        })
        .when('/addNLH/', {
            templateUrl: ctxfolder + '/addNLH.html',
            controller: 'addNLH'
        })
        .when('/addSubmit/', {
            templateUrl: ctxfolder + '/addSubmit.html',
...
app.controller('addMXH', function ($scope, $rootScope, $compile, $uibModal, $confirm, $uibModalInstance, dataservice) {
    $scope.initData = function () {
        dataservice.gettreedatacategory(function (result) {
            $scope.treeDatacategory = result.Object;
        });
...
app.controller('addCH', function ($scope, $rootScope, $compile, $uibModal, $confirm, $uibModalInstance, dataservice) {
    $scope.initData = function () {
        dataservice.gettreedatacategory(function (result) {
            $scope.treeDatacategory = result.Object;
        });
...
app.controller('addACE', function ($scope, $rootScope, $compile, $uibModal, $confirm, $uibModalInstance, dataservice) {
    $scope.initData = function () {
        dataservice.gettreedatacategory(function (result) {
            $scope.treeDatacategory = result.Object;
        });
...
app.controller('addHT', function ($scope, $rootScope, $compile, $uibModal, $confirm, $uibModalInstance, dataservice) {
    $scope.initData = function () {
        dataservice.gettreedatacategory(function (result) {
            $scope.treeDatacategory = result.Object;
        });
...
app.controller('addMDH', function ($scope, $rootScope, $compile, $uibModal, $confirm, $uibModalInstance, dataservice) {
    $scope.initData = function () {
        dataservice.gettreedatacategory(function (result) {
            $scope.treeDatacategory = result.Object;
        });
...
app.controller('addNC', function ($scope, $rootScope, $compile, $uibModal, $confirm, $uibModalInstance, dataservice) {
    $scope.initData = function () {
        dataservice.gettreedatacategory(function (result) {
            $scope.treeDatacategory = result.Object;
        });
...
app.controller('addNLH', function ($scope, $rootScope, $compile, $uibModal, $confirm, $uibModalInstance, dataservice) {
    $scope.initData = function () {
        dataservice.gettreedatacategory(function (result) {
            $scope.treeDatacategory = result.Object;
        });
...
app.controller('addSubmit', function ($scope, $rootScope, $compile, $uibModal, $confirm, $uibModalInstance, dataservice) {
    $scope.initData = function () {
        dataservice.gettreedatacategory(function (result) {
            $scope.treeDatacategory = result.Object;
        });
...
app.controller('addKHV', function ($scope, $rootScope, $compile, $uibModal, $confirm, $uibModalInstance, dataservice) {
    $scope.initData = function () {
        dataservice.gettreedatacategory(function (result) {
            $scope.treeDatacategory = result.Object;
        });
