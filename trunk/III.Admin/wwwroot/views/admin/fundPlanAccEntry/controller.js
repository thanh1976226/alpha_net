...
app.factory('dataservice', function ($http) {
    ...
    return {
        getAetType: function (callback) {
            $http.post('/Admin/FundPlanAccEntry/GetAetType').success(callback);
        },
        getUser: function (callback) {
            $http.post('/Admin/FundPlanAccEntry/GetUser').success(callback);
        },
        ...
        getGetAetRelative: function (callback) {
            $http.post('/Admin/FundPlanAccEntry/GetAetRelative').success(callback);
        },
        getGetAetRelativeType: function (callback) {
            $http.post('/Admin/FundPlanAccEntry/GetAetRelativeType').success(callback);
        },
        getListFundFiles: function (data, callback) {
            $http.post('/Admin/FundPlanAccEntry/GetListFundFiles?aetCode=' + data).success(callback);
        },
        uploadFile: function (data, callback) {
            submitFormUpload('/Admin/FundPlanAccEntry/UploadFile', data, callback);
        },
        removeFileReq: function (data, callback) {
            $http.post('/Admin/FundPlanAccEntry/RemoveFundFile?Id=' + data, callback).success(callback);
        },
        getListFundCategoryParent: function (callback) {
            $http.post('/Admin/FundPlanAccEntry/GetListFundCategoryParent').success(callback);
        },
        removeFileReq: function (data, callback) {
        ...
        getGetAccTrackingDetail: function (data, callback) {
            $http.get('/Admin/FundPlanAccEntry/GetAccTrackingDetail?aetCode=' + data).success(callback);
        },
        getItem: function (data, callback) {
            $http.post('/Admin/FundPlanAccEntry/GetItem/', data).success(callback);
        },
        insert: function (data, callback) {
            $http.post('/Admin/FundPlanAccEntry/Insert/', data).success(callback);
        },
        update: function (data, callback) {
            $http.post('/Admin/FundPlanAccEntry/Update/', data).success(callback);
        },
        delete: function (data, callback) {
            $http.post('/Admin/FundPlanAccEntry/Delete/' + data).success(callback);
        },
        getGenAETCode: function (type, catCode,title, callback) {
            $http.post('/admin/FundPlanAccEntry/GenAETCode?type=' + type + "&&catCode=" + catCode + "&&title=" + title ).success(callback);
        },
        insertAccEntryTracking: function (aetCode, status, note, callback) {
            $http.post('/admin/FundPlanAccEntry/InsertAccEntryTracking?aetCode=' + aetCode + "&&status=" + status + "&&note=" + note).success(callback);
        },
    }
});
...
app.controller('index', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $filter) {
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('CatName').withTitle('Tên danh mục').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('Title').withTitle('Tiêu đề').renderWith(function (data, type){
        return data;
    }).withOption('sWidth', '200px'));
    vm.dtColumns.push(DTColumnBuilder.newColumn('AetType').withTitle('Loại').renderWith(function (data, type) {
        if (data == "Receipt") {
            return "Thu";
        }
        else {
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('Total').withTitle('Số tiền').renderWith(function (data, type) {
        return '<span class="text-danger">' + $filter('currency')(data, '', 0) + '</span>';
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('Currency').withTitle('Loại tiền').renderWith(function (data, type) {
        return data;
    }));
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('Payer').withTitle('Người trả').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('Receiptter').withTitle('Người nhận').renderWith(function (data, type) {
        return data;
    }));
...
//        })
//        dataservice.getListFundCategoryParent(function (rs) {
//            $rootScope.listCatParent = rs.Object;
//        })
//    }
//    $scope.initData();
//    $scope.cancel = function () {
...
//        dataservice.getGenAETCode($scope.model.AetType, $scope.model.CatCode, $scope.model.Title,function (rs) {
