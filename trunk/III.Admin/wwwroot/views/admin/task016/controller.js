var ctxfolder = "/views/admin/task016";
...
app.factory('dataservice', function ($http) {
    ...
    return {
        insert: function (data, callback) {
            $http.post('/Admin/task016/insert', data).success(callback);
        },
        update: function (data, callback) {
            $http.post('/Admin/task016/update', data).success(callback);
        },
        //deleteItems: function (data, callback) {
        //    $http.post('/LgVendor/deleteItems', data).success(callback);
        //},
        delete: function (data, callback) {
            $http.post('/Admin/task016/delete/' + data).success(callback);
        },
        getItem: function (data, callback) {
            $http.get('/Admin/task016/getitem/' + data).success(callback);
        },
       
        gettreedataParent_id: function (callback) {
            $http.post('/Admin/task016/gettreedataParent_id/').success(callback);
        },
    }
});
...
app.controller('Ctrl_ESEIM', function ($scope, $rootScope, $compile, $uibModal, dataservice) {
    ...
    $rootScope.validationOptions = {
        ...
        messages: {
            code: {
                required: "Nhập mã cấp học",
                maxlength: "Mã cấp học k vượt quá 50 kí tự"
            },
            value: {
                required: "Nhập giá trị",
                maxlength: "Giá trị k vượt quá 50 kí tự"
            },
