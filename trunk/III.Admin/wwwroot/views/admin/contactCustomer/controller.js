...
var app = angular.module('App_ESEIM', ["ui.bootstrap", "ngRoute", "ngCookies", "ngValidate", "datatables", "datatables.bootstrap", "ngJsTree", "treeGrid", "pascalprecht.translate", 'datatables.colvis', "ui.bootstrap.contextMenu", 'datatables.colreorder', 'angular-confirm', 'ui.select']);
app.factory('dataservice', function ($http) {
    ...
    return {
        getItem: function (data, callback) {
            $http.get('/Admin/ContactCustomer/GetItem/' + data).success(callback);
        },
        insert: function (data, callback) {
            $http.post('/Admin/ContactCustomer/Insert/', data).success(callback);
        },
       
        update: function (data, callback) {
            $http.post('/Admin/ContactCustomer/Update/', data).success(callback);
        },
        delete: function (data, callback) {
            $http.post('/Admin/ContactCustomer/Delete/' + data).success(callback);
        },
...
app.controller('index', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $filter) {
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('MobilePhone').withTitle('{{ "CC_LIST_COL_CC_MOBIEPHONE" | translate }}').renderWith(function (data, type) {
        return data;
    }));
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('CreateTime').withTitle('{{ "CC_LIST_COL_CC_CREATETIME" | translate }}').renderWith(function (data, type, full) {
        return data != "" ? $filter('date')(new Date(data), 'dd/MM/yyyy') : null;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('FilePath').withTitle('{{ "CC_LIST_COL_CC_IMAGE" | translate }}').renderWith(function (data, type) {
