var ctxfolder = "/views/admin/dispatchesDocumentConfidentiality";
...
app.factory('dataservice', function ($http) {
    ...
    return {
        getItem: function (data, callback) {
            $http.post('/Admin/DispatchesDocumentConfidentiality/GetItem', data).success(callback);
        },
        insert: function (data, callback) {
            $http.post('/Admin/DispatchesDocumentConfidentiality/Insert', data).success(callback);
        },
        update: function (data, callback) {
            $http.post('/Admin/DispatchesDocumentConfidentiality/Update', data).success(callback);
        },
        delete: function (data, callback) {
            $http.post('/Admin/DispatchesDocumentConfidentiality/Delete', data).success(callback);
        },
    }
});
app.controller('Ctrl_ESEIM', function ($scope, $rootScope, $compile, $uibModal, $cookies, $translate, dataservice) {
    ...
    $rootScope.checkData = function (data) {
        ...
        if (!partternCode.test(data.Code)) {
            mess.Status = true;
            mess.Title = mess.Title.concat(" - ", caption.DDC_MSG_CHARACTER, "<br/>");
        }
        return mess;
    };
    ...
    $rootScope.validationOptions = {
        ...
        messages: {
            Code: {
                required: caption.DDC_MSG_NO_BLANK_CODE
            },
            Name: {
                required: caption.DDC_MSG_NO_BLANK_NAME
            }
        }
    }
    });
...
app.controller('index', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $filter) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/DispatchesDocumentConfidentiality/jtable",
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('Code').withTitle('{{"DDC_LIST_COL_CODE" | translate}}').renderWith(function (data, type, full, meta) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('Name').withTitle('{{"DDC_LIST_COL_NAME" | translate}}').withOption('sClass', 'tcenter').renderWith(function (data, type) {
        return data;
    }));

    vm.dtColumns.push(DTColumnBuilder.newColumn('action').notSortable().withTitle('{{"DDC_LIST_COL_ACTION" | translate}}').renderWith(function (data, type, full) {
