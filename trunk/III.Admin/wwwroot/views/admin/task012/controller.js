var ctxfolder = "/views/admin/task012";
...
app.factory('dataservice', function ($http) {
    ...
    return {
        insert: function (data, callback) {
            $http.post('/Admin/task012/insert', data).success(callback);
        },
        update: function (data, callback) {
            $http.post('/Admin/task012/update', data).success(callback);
        },
        //deleteItems: function (data, callback) {
        //    $http.post('/LgVendor/deleteItems', data).success(callback);
        //},
        delete: function (data, callback) {
            $http.post('/Admin/task012/delete/' + data).success(callback);
        },
        getItem: function (data, callback) {
            $http.get('/Admin/task012/getitem/' + data).success(callback);
        },
       
        gettreedataParent_id: function (callback) {
            $http.post('/Admin/task012/gettreedataParent_id/').success(callback);
        },
    }
});
