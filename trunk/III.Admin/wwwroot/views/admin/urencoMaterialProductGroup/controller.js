var ctxfolder = "/views/admin/urencoMaterialProductGroup";
...
app.factory('dataservice', function ($http) {
    ...
    return {
        insert: function (data, callback) {
            $http.post('/Admin/UrencoMaterialProductGroup/Insert', data, callback).success(callback);
        },
        update: function (data, callback) {
            $http.post('/Admin/UrencoMaterialProductGroup/Update', data).success(callback);
        },
        deleteItems: function (data, callback) {
            $http.post('/Category/DeleteItems', data).success(callback);
        },
        delete: function (data, callback) {
            $http.post('/Admin/UrencoMaterialProductGroup/Delete/' + data).success(callback);
        },
        getItem: function (data, callback) {
            $http.get('/Admin/UrencoMaterialProductGroup/GetItem/' + data).success(callback);
        },
        gettreedataCoursetype: function (callback) {
            $http.post('/Admin/UrencoMaterialProductGroup/gettreedataCoursetype/').success(callback);
        },
        gettreedataLevel: function (callback) {
            $http.post('/Admin/UrencoMaterialProductGroup/gettreedataLevel/').success(callback);
        },
...
app.controller('index', function ($scope, $rootScope, $confirm, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $translate, $window) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/UrencoMaterialProductGroup/Jtable",
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('Code').withTitle('Mã nhóm tài sản').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('Name').withTitle('Tên nhóm tài sản').renderWith(function (data, type) {
        return data;
    }));
