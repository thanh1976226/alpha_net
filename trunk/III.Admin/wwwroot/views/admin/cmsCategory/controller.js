...
var app = angular.module('App_ESEIM', ["ui.bootstrap", "ngRoute", "ngValidate", "datatables", "datatables.bootstrap", 'ui.tinymce', 'datatables.colvis', "ui.bootstrap.contextMenu", 'datatables.colreorder', 'angular-confirm', "ngJsTree", "treeGrid", "ui.select", "ngCookies", "pascalprecht.translate"]);
app.factory('dataservice', function ($http) {
    ...
    return {
        getUser: function (callback) {
            $http.post('/Admin/cms_categories/GetUser').success(callback);
        },
        getItem: function (data, callback) {
            $http.post('/Admin/cms_categories/GetItem/', data).success(callback);
        },
        insert: function (data, callback) {
            $http.post('/Admin/cms_categories/Insert/', data).success(callback);
        },
        update: function (data, callback) {
            $http.post('/Admin/cms_categories/Update/', data).success(callback);
        },
        delete: function (data, callback) {
            $http.post('/Admin/cms_categories/Delete/' + data).success(callback);
        },
...
app.controller('index', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $translate, $window) {
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('name').withTitle('{{"Tên" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('ordering').withTitle('{{"Sắp xếp" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('published').withTitle('{{"Hiển thị" | translate}}').renderWith(function (data, type) {
        return data;
    }));
