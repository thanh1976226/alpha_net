...
app.factory('dataservice', function ($http) {
    ...
    return {
        getUser: function (callback) {
            $http.post('/Admin/CMSManagementSlide/GetUser').success(callback);
        },
        getActivityType: function (callback) {
            $http.post('/Admin/CMSManagementSlide/GetActivityType').success(callback);
        },
        getAsset: function (callback) {
            $http.post('/Admin/CMSManagementSlide/GetAsset/').success(callback);
        },
        getItem: function (data, callback) {
            $http.post('/Admin/CMSManagementSlide/GetItem/', data).success(callback);
        },
        insert: function (data, callback) {
            $http.post('/Admin/CMSManagementSlide/Insert/', data).success(callback);
        },
        update: function (data, callback) {
            $http.post('/Admin/CMSManagementSlide/Update/', data).success(callback);
        },
        delete: function (data, callback) {
            $http.post('/Admin/CMSManagementSlide/Delete/' + data).success(callback);
        },
