var ctxfolder = "/views/Admin/UI12";
...
app.factory('dataservice', function ($http) {
    ...
    return {
        insert: function (data, callback) {
            submitFormUpload('/Admin/NewsCategory/Insert', data, callback);
        },
        update: function (data, callback) {
            submitFormUpload('/Admin/NewsCategory/Update', data, callback);
        },

        gettreedatacategory: function (callback) {
            $http.post('/Admin/NewsCategory/gettreedataCategory').success(callback);
        },

         getItem: function (data, callback) {
             $http.get('/Admin/NewsCategory/GetItem/' + data).success(callback);
        },

        deleteItems: function (data, callback) {
            $http.post('/Admin/NewsCategory/DeleteItems', data).success(callback);
        },
        delete: function (data, callback) {
            $http.post('/Admin/NewsCategory/Delete/' + data).success(callback);
        }  
    }
});
