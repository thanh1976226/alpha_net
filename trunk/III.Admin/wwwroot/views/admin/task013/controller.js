var ctxfolder = "/views/admin/task013";
...
app.factory('dataservice', function ($http) {
    ...
    return {
        insert: function (data, callback) {
            $http.post('/Admin/task013/insert', data).success(callback);
        },
        update: function (data, callback) {
            $http.post('/Admin/task013/update', data).success(callback);
        },
        //deleteItems: function (data, callback) {
        //    $http.post('/LgVendor/deleteItems', data).success(callback);
        //},
        delete: function (data, callback) {
            $http.post('/Admin/task013/delete/' + data).success(callback);
        },
        getItem: function (data, callback) {
            $http.get('/Admin/task013/getitem/' + data).success(callback);
        },
       
        gettreedataParent_id: function (callback) {
            $http.post('/Admin/task013/gettreedataParent_id/').success(callback);
        },
    }
});
...
app.controller('index', function ($scope, $rootScope, $compile, $confirm, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $filter) {
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('value').withTitle('Khóa học').renderWith(function (data, type) {
        return data;
    }));
    ...
    $scope.contextMenu = [
        [function ($itemScope) {
            return '<i class="fa fa-edit"></i>Cập nhật khóa học ';
        ...
        [function ($itemScope) {
            return '<i class="fa fa-remove"></i> Xóa khóa học';
        }, function ($itemScope, $event, model) {
