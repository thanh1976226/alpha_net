var ctxfolder = "/views/admin/CMSmanagementExtraField";
...
app.factory('dataservice', function ($http) {
    ...
    return {
        getUser: function (callback) {
            $http.post('/Admin/CMSManagementExtraField/GetUser').success(callback);
        },
        getActivityType: function (callback) {
            $http.post('/Admin/CMSManagementExtraField/GetActivityType').success(callback);
        },
        getAsset: function (callback) {
            $http.post('/Admin/CMSManagementExtraField/GetAsset/').success(callback);
        },
        getItem: function (data, callback) {
            $http.post('/Admin/CMSManagementExtraField/GetItem/', data).success(callback);
        },
        insert: function (data, callback) {
            $http.post('/Admin/CMSManagementExtraField/Insert/', data).success(callback);
        },
        update: function (data, callback) {
            $http.post('/Admin/CMSManagementExtraField/Update/', data).success(callback);
        },
        delete: function (data, callback) {
            $http.post('/Admin/CMSManagementExtraField/Delete/' + data).success(callback);
        },
...
app.controller('index', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataservice, $translate) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            url: "/Admin/CMSManagementExtraField/Jtable",
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('ActTitle').withTitle('{{ "Tên" | translate }}').renderWith(function (data, type) {
        return "cảnh sát biển";
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('ActNote').withTitle('{{ "Nhóm" | translate }}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('ActMember').withTitle('{{ "Loại" | translate }}').renderWith(function (data, type) {
        if (data != null) {
            var listUser = "";
            var list = data.split(',');
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('ActNote').withTitle('{{ "Sắp xếp" | translate }}').renderWith(function (data, type) {
        return "1/1/2000";
    }));
