...
namespace ESEIM.Controllers
{
    ...
    public class UI2Controller : Controller
    {
        ...
        public UI2Controller(EIMDBContext context, ILogger<UI2Controller> logger, IOptions<AppSettings> appSettings, IHostingEnvironment hostingEnvironment, IActionLogService actionLog)
        {
            _context = context;
            _logger = logger;
