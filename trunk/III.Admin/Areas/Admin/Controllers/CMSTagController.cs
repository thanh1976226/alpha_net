...
namespace III.Admin.Controllers
{
    ...
    {
        public class CMSTagsJtableModel
        {
        ...
        public CMSTagController(EIMDBContext context)
        {
            _context = context;
        }
        ...
        public class CMSTagJTableModel : JTableModel
        {
        ...
        [HttpPost]
        public object JTable([FromBody]CMSTagJTableModel jTablePara)
        {
            ...
            var jdata = JTableHelper.JObjectTable(data.ToList(), jTablePara.Draw, count, "Id", "name", "alias", "ordering");
            return Json(jdata);
        }
