...
{
    [Area("Admin")]
    public class IOTActionAnalysisController : BaseController
    {
        private readonly EIMDBContext _context;
        private readonly IUploadService _upload;

        public IOTActionAnalysisController(EIMDBContext context, IUploadService upload)
        {
            _context = context;
            _upload = upload;
        }
        ...
        //[HttpPost]
        //public object JTableAssetAllocation([FromBody]JTableModelAsset jTablePara)
        //{
        //    Dictionary<string, object> dictionary = new Dictionary<string, object>();
        //    dictionary.Add("draw", 1);
        //    dictionary.Add("recordsFiltered", 10);
        ...
        //    data.Add("Id", "1");
        //    data.Add("Code", "A_001");
        //    data.Add("Title", "Cấp ô tô");
        //    data.Add("Branch", "ACB Quang Trung");
        //    data.Add("Place", "Quận 1, Thành phố HCM");
        //    data.Add("Date", "02/10/2018");
        //    data.Add("Person", "Nguyễn Văn Hiếu");
        //    data.Add("Status", "Đã cấp");
        //    datas.Add(data);

        //    data = new Dictionary<string, string>();
        //    data.Add("Id", "2");
        //    data.Add("Code", "A_002");
        //    data.Add("Title", "Cấp chứng từ");
        //    data.Add("Branch", "ACB Kho HSCT");
        //    data.Add("Place", "Quận 2, Thành phố HCM");
        //    data.Add("Date", "02/11/2018");
        //    data.Add("Person", "Nguyễn Văn Cương");
        //    data.Add("Status", "Đã cấp");
        //    datas.Add(data);
        ...
        //    data.Add("Id", "3");
        //    data.Add("Code", "A_003");
        //    data.Add("Title", "Cấp căn hộ");
        //    data.Add("Branch", "ACB Quang Trung");
        //    data.Add("Place", "Quận 10, Thành phố HCM");
        //    data.Add("Date", "02/02/2019");
        //    data.Add("Person", "Đào Duy Từ");
        //    data.Add("Status", "Chưa cấp");
        //    datas.Add(data);
