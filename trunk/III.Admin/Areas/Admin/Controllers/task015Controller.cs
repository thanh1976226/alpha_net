...
{
    [Area("Admin")]
    public class task015Controller : Controller
    {
        private readonly EIMDBContext _context;
        public task015Controller(EIMDBContext context)
        {
            _context = context;
        ...
        public object jtable([FromBody]JTableModelCustom jTablePara)
        {
            ...
            var query = from a in _context.common_properties
                        where a.flag == 1 && a.code.Contains("EDU_COUNTRY_")
                        select new
                        {
                            id = a.id,
                            value = a.value,
        ...
        public JsonResult insert([FromBody]common_properties obj)
        {
            ...
            try
            {
                ...
                if(query.Count() == 0)
                {
                    ...
                    obj1.code = "EDU_COUNTRY_" + obj.code;
        ...
        public object gettreedataParent_id()
        {
            ...
            try
            {
                var data = _context.common_properties.OrderBy(x => x.id).Where(x => x.flag == 1 && x.code.Contains("EDU_COUNTRY_"));
                msg.Object = data;
                msg.Error = false;
            }
            catch (Exception ex)
