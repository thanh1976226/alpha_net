...
{
    [Area("Admin")]
    public class task013Controller : Controller
    {
        private readonly EIMDBContext _context;
        public task013Controller(EIMDBContext context)
        {
            _context = context;
        ...
        public object jtable([FromBody]JTableModelCustom jTablePara)
        {
            ...
            var query = from a in _context.common_properties
                        where a.flag == 1 && a.code.Contains("edu_type_")
                        select new
                        {
                            id = a.id,
                            value = a.value,
