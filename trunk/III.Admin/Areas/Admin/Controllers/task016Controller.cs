...
{
    [Area("Admin")]
    public class task016Controller : Controller
    {
        private readonly EIMDBContext _context;
        public task016Controller(EIMDBContext context)
        {
            _context = context;
        ...
        public object jtable([FromBody]JTableModelCustom jTablePara)
        {
            ...
            var query = from a in _context.common_properties
                        where a.flag == 1 && a.code.Contains("LevelStudent_")
                        select new
                        {
                            id = a.id,
                            value = a.value,
        ...
        public JsonResult insert([FromBody]common_properties obj)
        {
            ...
            try
            {
                ...
                if(query.Count() == 0)
                {
                    ...
                    obj1.code = "LevelStudent_" + obj.code;
