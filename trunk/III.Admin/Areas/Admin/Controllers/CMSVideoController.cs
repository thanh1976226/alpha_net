...
namespace III.Admin.Controllers
{
    ...
    public class CMSVideoController : BaseController
    {
        ...
        public CMSVideoController(EIMDBContext context)
        {
            _context = context;
        }
        ...
        //{
        //    var data = _context.CommonSettings.Where(x => x.Group == EnumHelper<AssetEnum>.GetDisplayValue(AssetEnum.CMSVideoType)).Select(x => new { Code = x.CodeSet, Name = x.ValueSet });
        //    return data;
        //}
        ...
        //[HttpPost]
        //public JsonResult Insert([FromBody]CMSVideo data)
        //{
        ...
        //[HttpPost]
        //public object Update([FromBody]CMSVideo data)
        //{
        //    var msg = new JMessage() { Error = false };
        //    try
        //    {
